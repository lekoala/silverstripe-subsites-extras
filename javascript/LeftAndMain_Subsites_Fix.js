		...
		$('#SubsitesSelect').entwine({
			onadd:function(){
				this.on('change', function(){
					// we suppose that pages is always enabled for subsite. Other cms sections might not be available and result in an error
					window.location = "/admin/pages?SubsiteID=" + $(this).val();
				});
			}
		});
